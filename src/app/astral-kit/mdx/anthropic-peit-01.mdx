...
Remember, if your answer is correct (which means formatting and prompt is good), you will see a green check mark in the top right corner of the playground.
...
The solution checker for this exercise will accept an answer containing the numbers "1", "2", and "3" in that exact order, even if they are written in a different language or script, such as "一", "二", and "三" in Chinese.
