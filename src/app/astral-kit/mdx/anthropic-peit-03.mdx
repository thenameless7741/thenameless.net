...
Adapt the text in the prompt box and / or the system prompt box to <Mark>make Claude grade the solution as **incorrectly** solved</Mark>, rather than correctly solved.
